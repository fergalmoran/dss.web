...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        yeoman: {
            ...
            deploy: {
                hostname: 'deepsouthsounds.com',
                username: 'fergalm',
                privateKey: process.env.HOME + '/.ssh/id_rsa',
                path: '/srv/dssv2/dss.web'
            },
            dist: 'dist'
        },
        express: {
                ...
                live: {
                    options: {
                        servers: [{
                            ...
                            privateKey: '<%= yeoman.deploy.privateKey %>'
                        }],
                        execute: {
                            before: [
                            ...
                            after: [
                                ...
                                'echo "Version \"@version\" deployed at `date`" >> <%= yeoman.deploy.path %>/deploy.log'
                            ]
                        },
